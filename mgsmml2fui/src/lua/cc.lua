        ...
        if k == 0 then
            ...
            elseif v == "%" then
               ...
               -- print("cur="..cur)
                ...
                cur = math.floor(cur)
                for i = 2, cur - 1 do
                    table.insert(vol, current_volume)
               ...
               -- print("cnt="..cnt)
                ...
                if node ~= nil then
                    ...
                    if node2 ~= nil and note_to_pitch[node2] ~= nil then
                        ...
                        --print("ins v=",note_volume)
                        for i=1,default_step do
                            table.insert(vol, note_volume)
                            table.insert(arp, current_node)
                        end
                       -- print("k2="..k.." "..strlen)
...
if argCount >= 2 then    
   ...
   --print(arg[3])
   if arg[3]~=nil and arg[3]=='-r' then
      default_step=1
   end
else
    local info=io.pathinfo(arg[0])
    print(info.filename.."  input.txt output_dir [-r]")
    print("-r compress setp to 1,default is 2")
    return
end
...
for k, v in ipairs(list) do
    --dump(v,k)
    local vol, arp = parse_mml_line(v[2])
